from .config_binance import CLIENT_SPOT
...
class BinanceAPISpot:
    """ 
    Базовый класс, описывающий логику взаимодействия с API биржи Binance. 
    Спотовый рынок.
    """

    def __init__(self, symbol, interval, qnty, open_position=False):
        """
        Конструктор класса BinanceAPISpot. Задает основные параметры, необходимые для взаимодействия
